            ...
            <div className="relative flex min-h-screen items-center justify-center bg-[url(/assets/images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
                <div className="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50  lg:flex-row lg:gap-10 xl:gap-0">
                    ...
                    <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        ...
                        <div className="w-full max-w-[440px] lg:mt-16">
                            ...
                            <form className="space-y-5 dark:text-white" onSubmit={submitForm}>
                                ...
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input onChange={(e) => setuser({ ...user, password: e.target.value })} id="Password" type="password" placeholder="Enter Password" className="form-input ps-10 placeholder:text-white-dark" />
                                        <span className="absolute start-4 top-1/2 -translate-y-1/2">
                        ...
                        <p className="absolute bottom-6 w-full text-center dark:text-white w-[80%]">© {new Date().getFullYear()}. Bea'h All rights reserved. Powered by AMY Softech.</p>
                    </div>
                </div>
            </div>
        </div>
