                ...
                <div className='flex gap-2 mt-3 md:flex-row flex-col'>
                        ...
                        <div className="max-w-4xl mx-auto md:p-3 p-1">
                            ...
                            <div className='flex md:flex-row flex-col'>
                                ...
                                <div className='md:basis-1/2 w-full'>
                                    ...
                                    <div className="py-2">
                                        <span className="font-bold">Tender Fee: </span>
                                        <span>100 $</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className='basis-[30%] h-[570px] p-3 bg-white rounded-md'>
                        ...
                        <div>
                            ...
                            <input type='text' placeholder='Enter Contact Number*' className='w-full border-2 p-3 rounded-md mt-2' />
                            <input type='number' placeholder='Enter Interested Tender Id*' className='w-full border-2 p-3 rounded-md mt-2' />
                            <textarea placeholder='Enter Message*' className='w-full border-2 p-3 rounded-md mt-2' />
                        </div>
